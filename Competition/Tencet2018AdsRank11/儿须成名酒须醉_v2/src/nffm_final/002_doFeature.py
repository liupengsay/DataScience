...
print('#####################加载CV_cvr数据##################')
train_cvcvr = pd.read_csv('./data/train_x_CV_cvr.csv')
evals_cvcvr = pd.read_csv('./data/evals_x_CV_cvr.csv')
test2_cvcvr = pd.read_csv('./data/test2_x_CV_cvr.csv')

print('#####################加载cvr数据##################')
train_cvr = pd.read_csv('./data/train_x_cvr.csv')
evals_cvr = pd.read_csv('./data/evals_x_cvr.csv')
test2_cvr = pd.read_csv('./data/test2_x_cvr.csv')

print('#####################加载ratio数据##################')
train_ratio = pd.read_csv('./data/train_x_ratio.csv')
evals_ratio = pd.read_csv('./data/evals_x_ratio.csv')
test2_ratio = pd.read_csv('./data/test2_x_ratio.csv')
